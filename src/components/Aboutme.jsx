...
function AboutMe() {
  ...
  const sections = [
    ...
    },
    {
      title: "Docs",
      content:
        "I’m obsessed with true crime documentaries and analyzing criminal psychology. It's fascinating to learn about criminal behavior and the justice system.",
      image: "src/assets/ccc.jpg",
    },
    {
      title: "Others",
      content:
