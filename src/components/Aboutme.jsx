    ...
    >
      ...
      >
        <p className="text-sm text-gray-300">
          When I'm not working on anything, I like to read, listen to music, or
          watch true crime documentaries. I go for runs, keep up on world news,
          and do pencil sketches too.
        </p>
      </motion.div>
      ...
      >
        {sections.map((section, index) => (
          <motion.div
            key={index}
            className="relative w-full sm:w-56 h-72 rounded-2xl shadow-lg text-center bg-black/40 backdrop-blur-lg border border-gray-700 overflow-hidden flex flex-col justify-between p-4 cursor-pointer"
